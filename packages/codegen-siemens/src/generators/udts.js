import { buildEquipmentTypesIR, siemensTypeName, } from '../compiler/program/types.js';
 ...
 */
export function generateUdts(project) {
...
export function siemensUdtNameForEquipment(eqType) {
